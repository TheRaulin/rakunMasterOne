            ...
            <tbody>
                ...
                <tr class="h-11">
                    ...
                    <td class="w-1/5 text-center border border-gray-500">
                        <a class="text-white border-4 rounded-xl border-blue-500 bg-blue-500" href="{{ route('customers.edit', $customer) }}">Editar</a>
                        <form class="inline" method="POST" action="{{ route('customers.destroy', $customer) }}">
                            @csrf @method('DELETE')
                            <a class="text-white border-4 rounded-xl border-red-500 bg-red-600" href="{{ route('customers.edit', $customer) }}" 
